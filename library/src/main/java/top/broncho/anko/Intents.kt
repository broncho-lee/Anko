...
inline fun <reified T : Service> Activity.stopService(vararg params: Pair<String, Any?>) =
...
inline fun Activity.browse(url: String, newTask: Boolean = false) = ctx.browse(url, newTask)

inline fun Fragment.browse(url: String, newTask: Boolean = false) = requireContext().browse(url, newTask)
...
inline fun Activity.share(text: String, subject: String = "") = ctx.share(text, subject)
inline fun Fragment.share(text: String, subject: String = "") = requireContext().share(text, subject)
...
inline fun Activity.email(email: String, subject: String = "", text: String = "") =
...
inline fun Activity.makeCall(number: String): Boolean = applicationContext.makeCall(number)
...
inline fun Activity.sendSMS(number: String, text: String = ""): Boolean =
    applicationContext.sendSMS(number, text)

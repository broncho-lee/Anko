 ...
 */
inline fun Activity.toast(message: Int) = applicationContext.toast(message)
 ...
 */
inline fun Activity.toast(message: CharSequence) = applicationContext.toast(message)
 ...
 * @param message the message text resource.
 */
inline fun Activity.longToast(message: Int) = applicationContext.longToast(message)
 ...
 * @param message the message text.
 */
inline fun Activity.longToast(message: CharSequence) = applicationContext.longToast(message)

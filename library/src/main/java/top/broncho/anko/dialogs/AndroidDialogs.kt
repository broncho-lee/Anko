...
) = applicationContext.alert(message, title, init)
...
inline fun Activity.alert(noinline init: AlertBuilder<DialogInterface>.() -> Unit) = applicationContext.alert(init)
...
inline fun Activity.progressDialog(
        message: Int? = null,
        title: Int? = null,
        noinline init: (ProgressDialog.() -> Unit)? = null
) = applicationContext.progressDialog(message, title, init)
...
@Deprecated(message = "Android progress dialogs are deprecated")
inline fun Activity.indeterminateProgressDialog(
        message: Int? = null,
        title: Int? = null,
        noinline init: (ProgressDialog.() -> Unit)? = null
) = applicationContext.indeterminateProgressDialog(message, title, init)

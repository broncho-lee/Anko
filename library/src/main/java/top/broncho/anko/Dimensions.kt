...
//inline fun Activity.dip(value: Int): Int = ctx.dip(value)
//inline fun Activity.dip(value: Float): Int = ctx.dip(value)
//inline fun Activity.sp(value: Int): Int = ctx.sp(value)
//inline fun Activity.sp(value: Float): Int = ctx.sp(value)
//inline fun Activity.px2dip(px: Int): Float = ctx.px2dip(px)
//inline fun Activity.px2sp(px: Int): Float = ctx.px2sp(px)
//inline fun Activity.dimen(@DimenRes resource: Int): Int = ctx.dimen(resource)
